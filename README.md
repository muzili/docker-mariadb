...
This example creates the image with the tag `muzili/mariadb`, but you can
change this to use your own username.

```
$ docker build -t="muzili/mariadb" .
```
...
``` shell
$ mkdir -p /tmp/mariadb
$ docker run -d -name="muzili/mariadb" \
